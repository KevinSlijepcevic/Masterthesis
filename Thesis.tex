...
\include{Metadaten/cover_sheet} %Deckblatt

\include{Inhalt/Abstract} %Falls ein Abstract eingefügt werden soll

\pagenumbering{gobble}

\include{Content/thanks.tex} %Danksagung
 
\pagenumbering{Roman}

\tableofcontents %Inhaltsverzeichnis

\include{Metadaten/acronyms} %Abkürzungsverzeichnis
...
\include{Metadaten/content}

% Literaturverzeichnis 
\bibliography{references} % Aufruf: bibtex Bibliographie.bib
...
\include{Metadaten/declaration} %Erklaerung.tex

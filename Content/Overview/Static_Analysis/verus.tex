...
%Overflow/Underflow, assert/assume, #[verifier(external_body)], Quanttifiers, Loop invariants, inline smt solver parameters, kein unsafe aber abstractions (interior mutability, heap pointers, concurrent data), spec/proof functions nur valid wenn sie terminieren; decrease clause
